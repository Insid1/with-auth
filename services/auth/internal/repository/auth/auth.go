...
func (r *Repository) GetJWTUserKey(_ context.Context, userID string) (string, error) {
	var jwtKey string
...
func (r *Repository) GenerateJWTUserKey(_ context.Context, userID string) (string, error) {
	var jwtKey string
