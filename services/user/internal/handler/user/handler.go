...
func (h *Handler) Get(_ context.Context, req *user_v1.GetReq) (*user_v1.GetRes, error) {
...
func (h *Handler) Create(_ context.Context, req *user_v1.CreateReq) (*user_v1.CreateRes, error) {
...
func (h *Handler) Update(_ context.Context, req *user_v1.UpdateReq) (*user_v1.UpdateRes, error) {
	usr := converter.ToModelFromUser(req.GetUser())
...
func (h *Handler) Delete(_ context.Context, req *user_v1.DeleteReq) (*user_v1.DeleteRes, error) {
...
func (h *Handler) CheckPassword(_ context.Context, req *user_v1.CheckPasswordReq) (*user_v1.CheckPasswordRes, error) {
